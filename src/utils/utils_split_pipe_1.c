...
{
    // Se o caractere for uma aspa simples e o flag de aspas simples não estiver ativo
    if (c == '\'' && *double_flag == 0)
    {
        *single_flag = !(*single_flag); // Alterna o estado do flag de aspas simples
    }
    // Se o caractere for uma aspa dupla e o flag de aspas duplas não estiver ativo
    else if (c == '\"' && *single_flag == 0)
    {
        *double_flag = !(*double_flag); // Alterna o estado do flag de aspas duplas
    }
}
